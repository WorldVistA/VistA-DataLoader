...
{
    public class QrdaDataLocationList
    {
        public QrdaDataLocationList()
        {
            this.QrdaDataLocations = new List<QrdaDataLocation>();
        }

        public List<QrdaDataLocation> QrdaDataLocations { get; set; }

        public void Clear()
        {
            this.QrdaDataLocations.Clear();
        }

        public IEnumerator<QrdaDataLocation> GetEnumerator()
        {
            return this.QrdaDataLocations.GetEnumerator();
        }
    }
}
