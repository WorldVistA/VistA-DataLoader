...
{
    public class QrdaMapList
    {
        public QrdaMapList()
        {
            this.QrdaMaps = new List<QrdaMap>();
        }

        public List<QrdaMap> QrdaMaps { get; set; }
        ...
        public IEnumerator<QrdaMap> GetEnumerator()
        {
            return this.QrdaMaps.GetEnumerator();
        }
    }
}
