...
{
    public class StringItemXmlList
    {

        public StringItemXmlList()
        {
        this.xmlitems = new List<StringItemXml>();
        }
        
        public List<StringItemXml> xmlitems { get; set; }
        ...
        public IEnumerator<StringItemXml> GetEnumerator()
        {
            return this.xmlitems.GetEnumerator();
        }
    }
}
