...
namespace DataLoader.Broker
{
    ...
    public class Request
    {
        ...
        {
            this.ParameterList.Add(new Parameter { Type = ParameterType.Literal, Value = value });
            return this;
        }

        public Request AddParameter(List<string> value)
        {
            this.ParameterList.Add(new Parameter { Type = ParameterType.List, Value = value });
            return this;
        }

        public Request AddParameter(Parameter param)
        {
            this.ParameterList.Add(new Parameter { Type = param.Type, Value = param.Value });
            return this;
        }
