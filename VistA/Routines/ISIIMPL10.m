ISIIMPL10 ;DOCME/SMH - Copy of LRVER3A;2025-03-14
...
VER ; Call with L ^LR(LRDFN,LRSS,LRIDT) from LRGV2, LRGVG1, LRSTUF1, LRSTUF2, LRVR3
 ...
 ; DOCME360/SMH - Fix Verify Date from being now to date of lab
 ;I '$G(LRFIX) S LRNOW=$$NOW^XLFDT,$P(^LR(LRDFN,LRSS,LRIDT,0),U,3,4)=LRNOW_U_$S($G(LRDUZ):LRDUZ,1:DUZ)
 I '$G(LRFIX) S LRNOW=$P(^LR(LRDFN,LRSS,LRIDT,0),U,1),$P(^LR(LRDFN,LRSS,LRIDT,0),U,3,4)=LRNOW_U_$S($G(LRDUZ):LRDUZ,1:DUZ)
 ; DOCME360/SMH - End
 K A2
